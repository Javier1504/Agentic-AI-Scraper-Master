...
# =========================
# HINT BURUK (BUKAN HALAMAN JURUSAN)
# =========================
BAD_HINT = [
    ...
    "penerimaan", "admission", "pmb",
    "program-studi", "program_studi", "programstudi", "prodi",
    "undergraduate", "graduate", "postgraduate",
    "sarjana", "magister", "doktor", "diploma",
]

PATH_BOOST_RE = re.compile(
    r"(fakultas|faculty|jurusan|department|departemen|akademik|academic)",
    re.I,
)
...
def pick_candidates_jurusan(seed_url: str, links: Union[List[str], List[Dict[str, str]]], limit: int) -> List[str]:
